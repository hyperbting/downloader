...
func TestDownloadTarget_sanitizeName(t *testing.T) {
	...
	tests := []struct {
		...
		{"t0-1", fields{"濡れてテカってピッタリ密着神スク水跡美しゅり美少女から人妻まで可愛い女子のスクール水着姿をじっとりと堪能濡れてテカってピッタリ密着神スク水跡美しゅり美少女から人妻まで可愛い女子のスクール水着姿をじっとりと堪能 跡美しゅり 跡美しゅり 跡美しゅり 跡美しゅり"}},
		...
		{"t1-2", fields{"1234567890 2234567890 3234567890 4234567890 5234567890 6234567890 7234567890 8234567890 9234567890 0234567890 1134567890 t123 t123 t123 t123 t123"}},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			d := &DownloadTarget{
...
func TestDownloadTarget_shortenName(t *testing.T) {
	type fields struct {
		Name string
	}
	tests := []struct {
